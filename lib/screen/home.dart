...
bool check= await db!.updateTodo(sno: todo[DbHelper.COLUMN_NOTE_SNO], isCompleted:pressed);
if(check){
  getTodo();
}
}
      ...
      body: Stack(
        children: [
         ...
         itemBuilder: (context,index){
          return TodoItem(todo: allTodo[index],onPressed: (){
            ...
            Positioned(
              ...
              left: 28,
              right: 95,
              child:TextfieldW(titleController: titleController,)  ),
        ],
      ),
